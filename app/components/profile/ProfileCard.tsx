            ...
            <div className="pc-content pc-avatar-content">
              ...
              {showUserInfo && (
                <div className="pc-user-info">
                  {(opinionCount !== undefined || likeCount !== undefined) && (
                    <div className="pc-stats">
                      {opinionCount !== undefined && (
                        <div className="pc-stat">
                          <span className="pc-stat-value">{opinionCount}</span>
                          <span className="pc-stat-label">Opinions</span>
                        </div>
                      )}
                      {likeCount !== undefined && (
                        <div className="pc-stat">
                          <span className="pc-stat-value">{likeCount}</span>
                          <span className="pc-stat-label">Likes</span>
                        </div>
                      )}
                    </div>
                  )}
